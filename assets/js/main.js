...
if (seleccion1 !== '1' && seleccion1 !== '2' && seleccion1 !== '3') { // pido que si la elección no es igual a: entonces falla, en caso contrario, avanza al jugador B
    alert('Opción inválida, debes elegir 1, 2 o 3') // si la opción no es válida, se termina el juego por que necesito que sea V solo 1 de las 3 opciones
} else {
...
if (seleccion2 !== '1' && seleccion2 !== '2' && seleccion2 !== '3') {
    ...
    let resultado = '' // string vacío porque no se que valor tomará
